<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="medexproject.Update" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Update Medicine Information</title>
    <meta charset="utf-8" />
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="Update.aspx">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="table-responsive">
                                                <div class="table align-items-center table-flush">
                                                    <!-- Chart -->
                                                    <asp:GridView ID="Update_GridView" runat="server" OnSelectedIndexChanged="Update_GridView_SelectedIndexChanged" DataKeyNames="SERIAL" GridLines="None" Width="100%">
                                                        <Columns>
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <asp:Label ID="Search_Label" runat="server" Text=""></asp:Label>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <asp:TextBox ID="strength_TextBox" autocomplete="off" class="form-control form-control-alternative" placeholder="strength" runat="server"></asp:TextBox>
                                                </div>
